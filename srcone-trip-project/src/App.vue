        ...
        <ul>
          <li>
            <a href="">
              ...
              <div class="wordbox">北京直飞马尔代夫6-7天往返含税机票（首都航空/售完为止）…</div>
            </a>
          </li>
          <li>
            <a href="">
              ...
              <div class="wordbox">[甩尾狂欢] 北京/天津直飞日本东京/大阪/冲绳/札幌/福冈4-7…</div>
            </a>
          </li>
          <li>
            <a href="">
          ...
          <li>
            <a href="">
              ...
              <div class="wordbox">[品质小团/快速确认] 新西兰福克斯冰川直升机观光+徒步…</div>
            </a>
          </li>
          <li>
            <a href="">
              ...
              <div class="wordbox">[北欧破冰船] 芬兰+瑞典极地探险号破冰船活动…</div>
            </a>
          </li>
          <li>
            <a href="">
              ...
              <div class="wordbox">[指定班期特惠][全程中文伴游] 摩洛哥全景深度10日游</div>
            </a>
          </li>
          <li>
            <a href="">
              ...
              <div class="wordbox">马来西亚天空之镜+河口赏鹰+夜游萤火虫+寻找蓝眼泪</div>
            </a>
          </li>
        </ul>
      </div>
          ...
          <ul>
            ...
            <li class="pro-grid">
              <a href="">
                ...
                <div class="wordbox">
                  北京/上海/南京/杭州直飞巴厘岛5-7天往返含税机票（赠送意外险…
                </div>
              </a>
            </li>
            <li class="pro-grid">
        ...
        <div class="bd">
          <div class="col">
            <div class="bigpicbox">
              ...
              <div class="info">
                <p class="proname">[亲子佳选]泰国清迈夜间动物园 可选接送+中文导游+餐赠小吃</p>
            ...
            <div class="grid">
              <a href="">
                ...
                <div class="wordbox">[樱花季] 北京/天津直飞东京/大阪/名古屋往返…</div>
              </a>
            </div>
          </div>
          <div class="col">
            ...
            <div class="grid">
              <a href="">
                ...
                <div class="wordbox">
                  [全岛接送+中文导游]
                  泰国普吉岛+皇帝岛+珊瑚岛一日游双体帆船海钓+浮潜+海鲜午餐+酒店接送
                </div>
              </a>
            </div>
            <div class="grid">
              <a href="">
                ...
                <div class="wordbox">享行之旅|泰国苏梅岛一日游 越野车丛林环岛之旅行</div>
              </a>
            </div>
          </div>
          <div class="col">
            <div class="grid">
              <a href="">
                ...
                <div class="wordbox">[樱花季] 北京/天津直飞东京/大阪/名古屋/往返…</div>
              </a>
            </div>
            <div class="more-grid">
              <a href="">
          ...
          <ul>
            <li>
              <a href="">
                ...
                <div class="wordbox">
                  <p class="proname">香港迪士尼乐园门票(一日 / 两日) - 扫码入园）</p>
                  <p>
            ...
            <li>
              <a href="">
                ...
                <div class="wordbox">
                  <p class="proname">英国巨石阵 & 温莎城堡 & 巴斯罗马浴场一日游</p>
                  <p>
                    <span class="score">★ 4.8</span>
          ...
          <ul>
            <li class="big-grid havehover">
              <a href="">
                ...
                <div class="word">
                  【City Walk】大阪浪花の城——美食、动漫和不为人知的大阪人辛秘...
                </div>
            ...
            <li class="pro-grid">
              <a href="">
                ...
                <div class="wordbox">北京/上海/南京/杭州直飞巴厘岛5-7天往返含税机票（赠送...</div>
              </a>
            </li>
            <li class="more-grid">
              <a href="">
          ...
          <ul>
            <li class="big-grid havehover">
              <a href="">
                ...
                <div class="word">【City Walk】大阪浪花の城——美食、动漫和不为人知的大阪人...</div>
                <img src="/images/yh.png" alt="" />
              </a>
            </li>
            <li class="pro-grid">
              <a href="">
                ...
                <div class="wordbox">
                  成都/西安直飞清迈+拜县6-7天半自助游（2-8人纯玩私家小包团…
                </div>
              </a>
            </li>
            <li class="pro-grid">
            ...
            <li class="pro-grid">
              <a href="">
                ...
                <div class="wordbox">
                  (免签入境）深圳直飞伊朗德黑兰8天5晚半自助游（含国际往返机票+伊朗签证）
                </div>
              </a>
            </li>
            <li class="more-grid">
      ...
      <div class="part1">
        <div class="center-wrap">
          ...
          <div class="dlbox clearfix">
            <dl class="txfw">
              <dt>贴心服务</dt>
              <dd>我们收集游客的真实诉求，寻找特色旅行目的地，让出行更放心</dd>
            </dl>
            <dl class="ccsx">
              <dt>层层筛选</dt>
              <dd>对旅游产品供应商严格筛选，层层把关</dd>
            </dl>
            <dl class="axph">
              <dt>安心陪护</dt>
              <dd>对游客的出行进行全程陪护，确保每一位旅客的安全与舒适</dd>
            </dl>
          </div>
        </div>
      </div>
      <div class="part2">
        <div class="center-wrap">
          <div class="r1 clearfix">
            ...
            <p class="slogan">
              从一张机票、一家酒店的订购，
              <br />到一次暖心的接机服务、一张轻松融入当地的交通卡让我们带你探索这个世界
            </p>
          </div>
          <div class="links clearfix">
            <ul>
              <li><a href="">关于慕云游</a></li>
          ...
          <div class="copyrights">&copy; 2026 营业执照备案<a href="">营业执照</a></div>
        </div>
      </div>
    </footer>
